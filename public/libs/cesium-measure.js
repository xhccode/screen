            ...
            */
            ...
            drawLineMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    var positions = [], _lineEntity = new Cesium.Entity(), $this = this, lineObj, labelObj=[],
                    ...
                    _handlers.setInputAction(function (movement) {
                        ...
                        if (cartesian && cartesian.x) {
                            ...
                            // 添加量测信息点
                            labelObj.push(_addInfoPoint(cartesian)) 
                    ...
                    _handlers.setInputAction(function (movement) {
                        ...
                        if (typeof options.callback === 'function') {
                            ...
                            options.callback($this.transformCartesianArrayToWGS84Array(positions), lineObj, labelObj);
                        }
                    ...
                    function _addInfoPoint(position) {
                        ...
                        let distance = $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(positions)) / 1000
                        let text = unit === '1' ?  (distance * 1000).toFixed(4) + '米' : distance.toFixed(4) + '公里'
                        _labelEntity.label = {
                            text,
                            show: true,
                            showBackground: true,
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    var positions = [], polygon = new Cesium.PolygonHierarchy(), _polygonEntity = new Cesium.Entity(), $this = this, polyObj = null, _labelArr = [],
                    ...
                    _handler.setInputAction(function (movement) {
                        ...
                        // 添加信息点
                        _labelArr.push(_addInfoPoint(positions[0]))
                        if (typeof options.callback === 'function') {

                            options.callback($this.transformCartesianArrayToWGS84Array(positions), polyObj, _labelArr);
                        }
                    }, Cesium.ScreenSpaceEventType.RIGHT_CLICK);
                    ...
                    function _addInfoPoint(position) {
                        ...
                        const area = $this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) / 1000000.0
                        const unit = options.unit
                        const text = unit === '1' ? (area * 1000000).toFixed(4) + '平方米' : area.toFixed(4) + '平方公里'
                        _labelEntity.label = {
                            text,
                            show: true,
                            showBackground: true,
            ...
            drawTrianglesMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    _handler.setInputAction(function (movement) {
                        ...
                        if (_positions.length == 0) {
                            ...
                            if (typeof options.callback === 'function') {
                                ...
                                options.callback([_trianglesEntity, _tempLineEntity, _tempLineEntity2]);
                            }
                        }
                    }, Cesium.ScreenSpaceEventType.LEFT_CLICK);
                    // mouse
                    ...
                    const triangle = $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_positions))
                    // const unit = options.unit
                    // triangleText = unit === '1' ? triangle + '米' : (triangle / 1000).toFixed(4) + '公里'
                    _trianglesEntity.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return options.unit === '1' ? '直线:' + $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_positions)) + '米' : '直线:' + ($this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_positions)) / 1000).toFixed(4) + '公里'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
                    ...
                    // const line =_getHeading(_tempPoints[0], _tempPoints[1])
                    // lineText = unit === '1' ? line + '米' : (line / 1000).toFixed(4) + '公里'
                    _tempLineEntity.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return options.unit === '1' ? '高度:' +  _getHeading(_tempPoints[0], _tempPoints[1]) + '米' : '高度:' +  (_getHeading(_tempPoints[0], _tempPoints[1]) / 1000).toFixed(4) + '公里'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
                    ...
                    // const line2 = $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_tempPoints2))
                    // line2Text = unit === '1' ? line2 + '米' : (line2 / 1000).toFixed(4) + '公里'
                    _tempLineEntity2.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return options.unit === '1' ? '水平距离:' + $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_tempPoints2)) + '米' : '水平距离:' + ($this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_tempPoints2)) / 1000).toFixed(4) + '公里'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
